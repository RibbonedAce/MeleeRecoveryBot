...
class FireFox(Chain):
    ...
    def step_internal(self, game_state, smashbot_state, opponent_state):
        ...
        if 0 <= self.current_frame < 40:
            ...
            if self.current_frame <= 9 and self.min_angle <= FireFox.ANGLES_TO_TEST[self.current_frame - 1] <= self.max_angle:
                next_point = FireFox.ANGLES_TO_TEST[self.current_frame - 1]
