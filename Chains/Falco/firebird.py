...
class FireBird(Chain):
    ...
    def create_trajectory(x_velocity, angle):
        trajectory = FireBird.TRAJECTORY.copy()
    ...
    def step_internal(self, game_state, smashbot_state, opponent_state):
        ...
        if self.trajectory is None:
            self.trajectory = FireBird.create_trajectory(useful_x_velocity, ControlStick.coordinate_num_to_angle(self.min_angle))
        ...
        if 0 <= self.current_frame < 40:
            ...
            if self.current_frame <= 9 and self.min_angle <= FireBird.ANGLES_TO_TEST[self.current_frame - 1] <= self.max_angle:
                next_point = FireBird.ANGLES_TO_TEST[self.current_frame - 1]
            ...
            self.trajectory = FireBird.create_trajectory(self.start_x_velocity, ControlStick.coordinate_num_to_angle(current_angle))
